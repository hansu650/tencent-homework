...
// 20 位虚拟实习生数据，用于模拟 HRBP、导师和新人在同一张成长地图里的协作视角。
export const students: Student[] = [
  {
    ...
    nextAction: "安排一次独立小需求拆解，用背景-问题-方案-风险框架输出。"
  },
  {
    id: "S002",
    name: "陈予安",
    ...
    nextAction: "尝试承担一个低风险接口的 owner，验证端到端交付意识。"
  },
  {
    id: "S003",
    name: "顾若澄",
