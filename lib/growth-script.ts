...
export const roleOptions: Option<RoleId>[] = [
  {
    id: "product",
    label: "产品新人",
    description: "业务理解、需求拆解、AI 辅助分析和协作产出",
    feedback:
      "成长副本将重点关注业务理解、需求拆解、AI 辅助分析和协作产出。"
  },
  {
    id: "engineering",
    label: "研发新人",
    description: "工程环境、代码理解、AI 辅助开发和质量意识",
    feedback:
      "成长副本将重点关注代码结构理解、AI 辅助开发、测试意识和小功能交付。"
  },
  {
    id: "operations",
    label: "运营新人",
    description: "指标理解、用户洞察、内容或活动执行和复盘",
    feedback:
      "成长副本将重点关注业务指标、用户画像、AI 辅助方案生成和运营实验。"
  },
  {
    id: "hr",
    label: "HR 新人",
    description: "招聘培养流程、员工服务、AI-HR 工具和机制设计",
    feedback:
      "成长副本将重点关注 HR 流程理解、AI 辅助 SOP、反馈模板和流程优化。"
  },
  {
    id: "design",
    label: "设计新人",
    description: "设计规范、AI 灵感收集、方案探索和交互优化",
    feedback:
      "成长副本将重点关注设计规范、AI 辅助灵感、方案表达和可展示改版。"
  }
];
...
export const aiLevelOptions: Option<AiLevelId>[] = [
  {
    ...
    label: "AI 小白",
    description: "只用过问答工具",
    feedback: "前 30 天需要安排更明确的 AI 工具入门和提示词练习。"
  },
  {
    id: "basic",
    label: "AI 入门",
    description: "会用 AI 写文案、整理资料",
    feedback: "可以从信息整理过渡到岗位任务拆解，强调验证和复盘。"
  },
  {
    id: "advanced",
    label: "AI 进阶",
    description: "能用 AI 做分析、原型、代码辅助",
    feedback: "适合更快进入真实任务，把 AI 用法沉淀为工作流。"
  },
  {
    id: "coCreate",
    label: "AI 共创",
    description: "能把 AI 融入完整工作流",
    feedback: "可以设置更高挑战，让新人完成一个可复用的 AI Native 小项目。"
  }
];
...
export const growthGoalOptions: Option<GrowthGoalId>[] = [
  {
    id: "teamFit",
    label: "快速融入团队",
    description: "先理解角色、节奏和协作方式",
    feedback: "路径会增加团队沟通、业务地图和导师检查点。"
  },
  {
    id: "aiToolchain",
    label: "掌握 AI 工具链",
    description: "从会用工具到会设计工作流",
    feedback: "路径会强化 AI 工具建议、提示词练习和工具复盘。"
  },
  {
    id: "businessRole",
    label: "理解业务和岗位要求",
    description: "把岗位能力和业务目标连起来",
    feedback: "路径会突出业务目标、岗位交付物和阶段验收标准。"
  },
  {
    id: "showcaseProject",
    label: "完成一个可展示的小项目",
    description: "最终形成可复盘、可展示的产出",
    feedback: "路径会围绕 90 天小项目倒推任务和导师验收。"
  },
  {
    id: "humanAiHabit",
    label: "建立人机协作习惯",
    description: "学会记录 AI 参与过程和人的判断",
    feedback: "路径会要求记录 AI 使用过程、反思和边界判断。"
  }
];
...
export const mentorStyleOptions: Option<MentorStyleId>[] = [
  {
    ...
    label: "轻陪伴",
    description: "每周一次反馈",
    feedback: "导师检查点会更轻量，适合稳定跟进和低压力融入。"
  },
  {
    id: "project",
    label: "项目制",
    description: "围绕一个小项目推进",
    feedback: "路径会把 30/60/90 串成一个可展示小项目的推进过程。"
  },
  {
    id: "challenge",
    label: "高挑战",
    description: "阶段验收 + 明确交付物",
    feedback: "路径会强化阶段交付物、验收标准和结果复盘。"
  },
  {
    id: "coCreate",
    label: "共创型",
    description: "导师和新人一起用 AI 做小项目",
    feedback: "路径会突出导师共创、AI 协作和方法沉淀。"
  }
];
...
const roleStageContent: Record<RoleId, Record<GrowthStage["id"], Omit<GrowthStage, "id" | "title" | "subtitle">>> = {
  product: {
    "30": {
      goal: "理解业务、熟悉团队、掌握基础 AI 工具。",
      tasks: ["业务地图学习", "用户问题整理", "AI 辅助竞品分析"],
      deliverable: "一页业务地图 + 3 个关键用户问题",
      mentorChecks: ["能否说清用户、场景和核心指标", "能否区分事实、判断和建议"],
      tools: ["AI 搜集竞品信息", "AI 辅助整理用户访谈纪要"]
    },
    "60": {
      goal: "参与真实需求讨论，开始用 AI 辅助完成产品分析。",
      tasks: ["参与一次需求评审", "用 AI 拆解用户反馈", "输出需求分析卡"],
      deliverable: "一张需求分析卡",
      mentorChecks: ["能否讲清需求背后的业务问题", "能否提出可验证的方案假设"],
      tools: ["AI 聚类用户反馈", "AI 生成需求澄清问题"]
    },
    "90": {
      goal: "完成一个 AI 辅助产品优化小项目并复盘。",
      tasks: ["定义优化目标", "验证一个小方案", "沉淀项目复盘"],
      deliverable: "AI 辅助产品优化小项目复盘",
      mentorChecks: ["能否说明项目价值、方法和风险", "能否总结下一阶段成长计划"],
  ...
  operations: {
    ...
    "90": {
      ...
      tools: ["AI 生成实验方案", "AI 辅助分析实验结果"]
    }
  },
  hr: {
    "30": {
      goal: "理解招聘、培养和员工服务流程，用 AI 辅助整理 SOP。",
      tasks: ["学习 HR 流程地图", "AI 辅助整理 SOP", "观察一次员工服务场景"],
  ...
  design: {
    "30": {
      ...
      mentorChecks: ["能否说清设计规范的使用场景", "能否说明参考案例的优缺点"],
      tools: ["AI 生成灵感关键词", "AI 辅助整理竞品界面观察"]
    },
    "60": {
      goal: "参与一次真实需求设计，用 AI 生成多版草图和文案。",
      tasks: ["参与需求设计", "用 AI 生成多版草图方向", "输出交互说明"],
      deliverable: "设计方案草图 + 交互说明",
      mentorChecks: ["方案是否回应用户问题", "表达是否清楚并能接受反馈"],
      tools: ["AI 辅助生成界面文案", "AI 辅助做方案对比"]
    },
    "90": {
...
export function buildGrowthPlan(input: Partial<GrowthProfile>) {
  ...
  const stages = (["30", "60", "90"] as const).map((id) => {
    ...
    const stageName =
      id === "30" ? "入门副本" : id === "60" ? "协作副本" : "产出副本";

    return {
      id,
      title: `${id} 天：${stageName}`,
      subtitle:
        id === "30"
          ? "理解业务与 AI 工具"
          : id === "60"
...
export function buildEvaluationMetrics(profile: Partial<GrowthProfile>) {
  ...
  return [
    `是否能围绕「${plan.role.label}」说清岗位目标和阶段交付物`,
    `是否能把 AI 从工具使用推进到「${plan.growthGoal.label}」`,
    "是否能记录 AI 使用过程、人的判断依据和复盘结论",
