  ...
  产品: [
    {
      ...
      mentorSignal: "能否讲清楚用户是谁、业务目标是什么、当前卡点是什么",
      hrbpSignal: "业务理解、主动提问、学习速度",
      goal: "先理解业务目标、用户角色和核心指标，不急着输出方案。",
      steps: ["阅读业务材料和历史需求", "准备用户、目标、卡点 3 个问题", "输出背景笔记", "请导师按业务理解给出反馈"]
    },
    {
      id: "product-review",
      title: "参与一次需求评审",
      ...
      steps: ["提前看需求背景", "会上记录事实、判断、建议", "会后整理 3 条风险", "把纪要发给导师确认"]
    },
    {
  ...
  研发: [
    {
      ...
      steps: ["阅读环境文档", "记录安装和报错", "跑通核心服务", "请导师确认阻塞点是否清楚"]
    },
    {
      id: "dev-code-reading",
      title: "阅读一个核心模块代码",
